...
public class PasswordRecoveryDialog extends javax.swing.JDialog implements MessageShowing {
    ...
    public void showErrorMessage(String message) {
        JOptionPane.showMessageDialog(this, message, "Password Recovery Dialog", JOptionPane.ERROR_MESSAGE, AppConstant.IMAGE_ICON_MESSAGE_DIALOG_ERROR);
    }

    @Override
    public void showInfoMessage(String message) {
        JOptionPane.showMessageDialog(this, message, "Password Recovery Dialog", JOptionPane.INFORMATION_MESSAGE, AppConstant.IMAGE_ICON_MESSAGE_DIALOG_INFO);
    }

    @Override
    public void showWarningMessage(String message) {
        JOptionPane.showMessageDialog(this, message, "Password Recovery Dialog", JOptionPane.WARNING_MESSAGE, AppConstant.IMAGE_ICON_MESSAGE_DIALOG_WARNING);
    }
