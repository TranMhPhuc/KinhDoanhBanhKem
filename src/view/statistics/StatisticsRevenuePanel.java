...
public class StatisticsRevenuePanel extends javax.swing.JPanel {

    private volatile static StatisticsRevenuePanel uniqueInstance;

    private StatisticsControllerInterface controller;

    private StatisticsRevenuePanel(StatisticsControllerInterface controller) {
        if (controller == null) {
    ...
    public static StatisticsRevenuePanel getInstance(StatisticsControllerInterface controller) {
        if (uniqueInstance == null) {
            synchronized (StatisticsRevenuePanel.class) {
                if (uniqueInstance == null) {
                    uniqueInstance = new StatisticsRevenuePanel(controller);
                }
            }
        }
    ...
    public static StatisticsRevenuePanel getInstance() {
        if (uniqueInstance == null) {
